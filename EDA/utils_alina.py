...
def cluster_ts(data:[pd.DataFrame], n_clusters:[int], id_column="id", date_column="date"):
    clustering_data_scaled = data.pivot(index=date_column, columns=[id_column])
    ...
    clusters = kmeans.fit_predict(clustering_data_scaled.T)
